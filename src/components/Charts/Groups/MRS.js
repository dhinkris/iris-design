            ...
            <div style={{
                ...
                <div id ="graphArea">
                    ...
                    <div style={{ marginTop: 16 }}>
                        <Row gutter={24}>
                            <Col span={8} ><LineChart toPlot='myoInositol' y_lower_limit = {0} y_upper_limit={40} title='myoInositol'/></Col>
                            <Col span={8} ><LineChart toPlot='totalCholine' y_lower_limit = {0} y_upper_limit={5} title='totalCholine'/></Col>
                            <Col span={8} ><LineChart toPlot='totalNAA' y_lower_limit = {0} y_upper_limit={10} title='totalNAA'/></Col>
                            <Col span={8} ><LineChart toPlot='totalCreatine' y_lower_limit = {0} y_upper_limit={7} title='totalCreatine'/></Col>
                        </Row>
                    </div>
                </div>
            </div>
