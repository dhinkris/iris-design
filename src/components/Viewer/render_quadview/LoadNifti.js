...
function render() {
    ...
    if (ready) {
        ...
        r1.renderer.render(r1.scene, r1.camera, redTextureTarget, true);
        r1.renderer.clearDepth();
...
class LoadNifti extends React.Component{
    ...
    async componentDidMount(){
        ...
        loader.loadData(t2, 'https://cdn.rawgit.com/FNNDSC/data/master/nifti/fetalatlas_brain/t2/template_T2.nii.gz')
            .then(function() {
                ...
                // r1.camera.lookAt(centerLPS.x, centerLPS.y, centerLPS.z)
                // r1.camera.updatePrjectionMatrix()
                // r1.controls.target.set(centerLPS.x, centerLPS.y, centerLPS.z)
                ...
                // r1.scene.add(boxHelper);

                // red slice
                initHelpersStack(r1, stack);
                // r1.scene.add(r1.scene);
                ...
                //     if (event.buttons===1){
                //         console.log(event)
                //         r1.domElement.addEventListener('mousemove', onDoubleClick);
                //         r2.domElement.addEventListener('mousemove', onDoubleClick);
                //         r3.domElement.addEventListener('mousemove', onDoubleClick);
                //     }else
                //     if (event.buttons===0){
                //         r1.domElement.removeEventListener('mousemove', onDoubleClick);
                //         r2.domElement.removeEventListener('mousemove', onDoubleClick);
                //         r3.domElement.removeEventListener('mousemove', onDoubleClick);
                //     }
                // }
                //
                // r1.domElement.addEventListener('mousedown', onMouseDown);
                // r1.domElement.addEventListener('mouseup', onMouseDown);
                //
                // r2.domElement.addEventListener('mousedown', onMouseDown);
                // r2.domElement.addEventListener('mouseup', onMouseDown);
                //
                // r3.domElement.addEventListener('mousedown', onMouseDown);
                // r3.domElement.addEventListener('mouseup', onMouseDown);
